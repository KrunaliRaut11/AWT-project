                    ...
                    <form name='registration' class="form" method="post" action="">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="middlename" class="form-control" placeholder="Middle name" onblur="allLetterMiddle()">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons users_circle-08"></i>
                                </span>
                                <input type="text" name="lastname" class="form-control" placeholder="Last name" onblur="allLetterLast()">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons ui-1_email-85"></i>
                                </span>
                                <input type="text" name="email" class="form-control" placeholder="Email" onblur="ValidateEmail()">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons business_bank"></i>
                                </span>
                                <input type="text" name="address" class="form-control" placeholder="Complete address" onblur="alphanumeric()">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons tech_mobile"></i>
                                </span>
                                <input type="text" name="contact" class="form-control" placeholder="Contact info" onblur="allnumeric()">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons users_single-02"></i>
                                </span>
                                <input type="text" id="username" name="username" class="form-control" placeholder="Username" onblur="alphanumericUser()">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                        ...
                        <div class="footer text-center">
                          ...
                          <div class="pull-left">
                            <h6>
                                <a href="user_login_page.php" class="link">Already have account</a>
                            </h6>
                        </div>
                    </form>
                </div>
