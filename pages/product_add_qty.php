  ...
  <div class="panel-body">
    <form action="product_add_qty.php" method="post">
        <div class="form group">
            ...
            <label for="category">Product event: &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <?php echo $category;?></label><br><br>
            <label for="event">Product Category: &nbsp &nbsp &nbsp &nbsp &nbsp <?php echo $event;?></label><br><br>
