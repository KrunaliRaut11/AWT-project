...
if(isset($_POST['submit'])){
    ...
    if(empty($prod_name) || empty($prod_desc) || empty($prod_qty) || empty($prod_cost) || empty($prod_price) ||  empty($event) || empty($prod_serial) || empty($prod_pic1) || empty($prod_pic2) || empty($prod_pic3)){    
        ...
        $query = "INSERT INTO products (prod_name, prod_desc, prod_qty, prod_cost, prod_price, event, prod_serial, prod_pic1, prod_pic2, prod_pic3) 
        VALUES ('$prod_name','$prod_desc','$prod_qty','$prod_cost','$prod_price','$event','$prod_serial','$prod_pic1','$prod_pic2','$prod_pic3')";  
