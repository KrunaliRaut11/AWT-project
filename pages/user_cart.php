              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <select class="btn btn-warning btn-round dropdown-toggle" size="1" name="states">
                      <option value="Andhra Pradesh states">Andhra Pradesh</option>
                      <option value="Assam states">Assam</option>
                      <option value="Bihar states">Bihar</option>
                      <option value="Goa states">Goa</option>
                      <option value="Gujarat states">Gujarat</option>
                      <option value="Haryana states">Haryana</option>
                      <option value="Himachal Pradesh states">Himachal Pradesh</option>
                      <option value="Jharkhand states">Jharkhand</option>
                      <option value="Karnataka states">Karnataka</option>
                      <option value="Kerala states">Kerala</option>
                      <option value="Maharashtra states">Maharashtra</option>
                      <option value="Punjab states">Punjab</option>
                      <option value="Rajasthan states">Rajasthan</option>
                      <option value="Telangana states">Telangana</option>
                      <option value="Uttarakhand states">Uttarakhand</option>
                      <option value="West Bengal states">West Bengal</option>
                      </select>  
                      </div>
