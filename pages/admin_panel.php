                    ...
                    <div class="col-md-9 ml-auto mr-auto">
                        ...
                        <div class="nav-align-center">
                            <ul class="nav nav-pills nav-pills-primary" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#event" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#cont_accounts" role="tablist">
                                        <i class="now-ui-icons users_circle-08"></i>
                                    </a>
                                </li>
                            </ul>
 ...
 <br><br>
                        ...
                        <div class="tab-pane" id="event" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                echo "<td>".$res['event_desc']."</td>"; 
                                                echo "<td><a href=\"event_update.php?event_id=$res[event_id]\">Edit</a> | <a href=\"event_delete.php?event_id=$res[event_id]
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="event_add.php"><i class="now-ui-icons ui-1_simple-add"></i> Add event</a>
                                </div>
                            </div>
                        </div>
...
<!--contact us info-->
                      ...
                      <div class="tab-pane" id="cont_accounts" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                    <br>
                                    <div class="row">
                                      ...
                                      <th>Option</th>
                                        ...
                                        <?php
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                echo "<td>".$res['cont_id']."</td>";
                                                echo "<td>".$res['name']."</td>";
                                                echo "<td>".$res['email']."</td>"; 
                                                echo "<td>".$res['message']."</td>";
                                                echo "<td><a href=\"cont_delete.php?cont_id=$res[cont_id]
                                                \" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }?>
